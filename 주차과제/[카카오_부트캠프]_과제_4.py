...
Original file is located at
    https://colab.research.google.com/drive/1TgPuWQLH_TiwjB8uOVuW8WK3-Xe8pJ-0
...
def replace_outliers(column):
    ...
    # 조건부 선택 : column.where(condition, np.nan)은 주어진 condition이 True인 경우 해당 값을 유지하고, False인 경우 np.nan으로 대체합
